...
<link rel="stylesheet" href='<c:url value="/css/studentProfile.css"/>' id="bootstrap-css">
					...
					<div class="col-sm-12">
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								placeholder="Enter First Name Here.." class="form-control" value="${student.name}" readonly="readonly">
							</div>
						</div>
