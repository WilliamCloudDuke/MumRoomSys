			...
			<div class="form-group">
				...
				<div class="col-xs-9">
					<div
						...
						<p>I Agree to leave the room in the same condition that it was
							upon my arrival. I accept responsibility for all its contents,
							and any items of University furniture that I wish to have stored
							I will record below with my Resident Hall Director or Resident
							Advisor's Approval.</p>
